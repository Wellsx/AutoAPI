...
describe('petstore.swagger API tests', () => {
      ...
      it('GET - login', () => {
        cy.request('https://petstore.swagger.io/v2/user/login?username=Test&password=password123')
        .then(
          (response) => {
            expect(response.status).to.equal(200)
      })
      ...
      it('GET - pet id', () => {
        cy.request('https://petstore.swagger.io/v2/pet/754366')
        .then(
          (response) => {
      ...
      it('DELETE - delete pet', () => {
        cy.request('DELETE', 'https://petstore.swagger.io/v2/pet/754366')
          .then(
            (response) => {
              expect(response.status).to.equal(200),
